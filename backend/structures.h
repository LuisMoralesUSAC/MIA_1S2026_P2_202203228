...
struct Journal {
    int j_count;                   // Contador de operaciones registradas
    Information j_content[50];     // Array de 50 entradas de journal
